...
\restrict ZmG7hWlWDMwIBg6EFUy38F4YOAvpRLaHvEMqZAuCN4BJprhjDHvHW2YFU7ZQVUl
...
--
-- Name: dashboard_stats_history; Type: TABLE; Schema: public; Owner: shopsyncflow_user
--

CREATE TABLE public.dashboard_stats_history (
    id character varying DEFAULT gen_random_uuid() NOT NULL,
    date timestamp without time zone NOT NULL,
    total_tasks integer DEFAULT 0 NOT NULL,
    pending_review integer DEFAULT 0 NOT NULL,
    overdue_sla integer DEFAULT 0 NOT NULL,
    completed_today integer DEFAULT 0 NOT NULL,
    kanban_counts jsonb DEFAULT '{}'::jsonb NOT NULL,
    created_at timestamp without time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.dashboard_stats_history OWNER TO shopsyncflow_user;
...
--
-- Name: shopify_product_mappings; Type: TABLE; Schema: public; Owner: shopsyncflow_user
--
...
ALTER TABLE public.shopify_product_mappings OWNER TO shopsyncflow_user;

--
-- Name: shopify_stores; Type: TABLE; Schema: public; Owner: shopsyncflow_user
--
...
ALTER TABLE public.shopify_stores OWNER TO shopsyncflow_user;
...
--
-- Data for Name: dashboard_stats_history; Type: TABLE DATA; Schema: public; Owner: shopsyncflow_user
--

COPY public.dashboard_stats_history (id, date, total_tasks, pending_review, overdue_sla, completed_today, kanban_counts, created_at) FROM stdin;
82eb530c-e1a9-41d4-91dc-4746086c8541	2025-10-21 02:02:31.596825	5	2	1	0	{"NEW": 0}	2025-10-27 02:02:31.596825
28e36a1d-ebbd-447f-9a51-8f25f8d68483	2025-10-22 02:02:31.596825	7	3	2	1	{"NEW": 0}	2025-10-27 02:02:31.596825
3ef1d1cd-27eb-402e-bb0c-f16de5af6d37	2025-10-23 02:02:31.596825	10	4	2	2	{"NEW": 0}	2025-10-27 02:02:31.596825
904730ae-865c-482b-9c1c-b9c375b9271d	2025-10-24 02:02:31.596825	12	5	3	3	{"NEW": 0}	2025-10-27 02:02:31.596825
2dbcac91-bbfc-499b-aba1-4f16b77a8423	2025-10-25 02:02:31.596825	15	6	4	2	{"NEW": 0}	2025-10-27 02:02:31.596825
9c9cd19e-9cf9-45c2-8ef3-e9f6e2289d2b	2025-10-26 02:02:31.596825	18	7	5	4	{"NEW": 0}	2025-10-27 02:02:31.596825
9a106a65-514e-4c7a-851b-7e45a38449bf	2025-10-27 02:02:31.596825	20	8	6	5	{"NEW": 0}	2025-10-27 02:02:31.596825
\.
...
7c971e56-7470-4b29-acc1-52793d46ef6b	will@nexusclothing.com	127.0.0.1	Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36	t	\N	2025-10-27 01:55:08.269136
\.
...
zN9LD_1-cKDIb1lZDJI9eMZVUpn2DwJN	{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"},"passport":{"user":"7693d534-1877-4453-9e89-646ea16397c8"}}	2025-10-28 02:53:47
\.


--
-- Data for Name: shopify_product_mappings; Type: TABLE DATA; Schema: public; Owner: shopsyncflow_user
--

COPY public.shopify_product_mappings (id, product_id, shopify_store_id, shopify_product_id, shopify_handle, published_at, status, last_sync_at, created_at) FROM stdin;
\.


--
-- Data for Name: shopify_stores; Type: TABLE DATA; Schema: public; Owner: shopsyncflow_user
--

COPY public.shopify_stores (id, name, shop_domain, access_token, is_active, webhook_secret, created_at, updated_at) FROM stdin;
\.
...
COPY public.users (id, username, email, password, role, first_name, last_name, created_at, updated_at, account_status, email_verified, email_verification_token, two_factor_secret, two_factor_enabled, two_factor_backup_codes, phone_number, profile_completed) FROM stdin;
7693d534-1877-4453-9e89-646ea16397c8	admin	will@nexusclothing.com	b0777a5c146795643e62ed2313c2cc073653ea47a2f9035731992cdaed2f4735e52b53ec98cdb27958d7b04992d23d3cd73f99106a46bc2dd548f060d4a32381.611bc3d7b38e2fa5103a15fa1cd682b2	SuperAdmin	Will	Shawky	2025-09-17 04:02:09.698313	2025-10-27 02:36:48.957	active	f	\N	\N	f	\N	+1 7576199567	t
\.
...
--
-- Name: dashboard_stats_history dashboard_stats_history_pkey; Type: CONSTRAINT; Schema: public; Owner: shopsyncflow_user
--

ALTER TABLE ONLY public.dashboard_stats_history
    ADD CONSTRAINT dashboard_stats_history_pkey PRIMARY KEY (id);
...
--
-- Name: shopify_product_mappings shopify_product_mappings_pkey; Type: CONSTRAINT; Schema: public; Owner: shopsyncflow_user
--
...
--
-- Name: shopify_stores shopify_stores_pkey; Type: CONSTRAINT; Schema: public; Owner: shopsyncflow_user
--
...
--
-- Name: shopify_stores shopify_stores_shop_domain_unique; Type: CONSTRAINT; Schema: public; Owner: shopsyncflow_user
--

ALTER TABLE ONLY public.shopify_stores
    ADD CONSTRAINT shopify_stores_shop_domain_unique UNIQUE (shop_domain);
...
\unrestrict ZmG7hWlWDMwIBg6EFUy38F4YOAvpRLaHvEMqZAuCN4BJprhjDHvHW2YFU7ZQVUl
